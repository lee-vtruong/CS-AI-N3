...
def plot_rastrigin_robustness():
    ...
    rawdata_file = 'rastrigin_raw_fitness.csv'
    ...
    for D in dimensions:
        ...
        output_file = os.path.join(vis_dir, f'robustness_rastrigin_D{D}.png')
        plt.tight_layout()
...
def plot_knapsack_robustness():
    ...
    rawdata_file = 'knapsack_raw_fitness.csv'
    ...
    for n in n_items_list:
        ...
        # Save figure
        vis_dir = os.path.dirname(os.path.abspath(__file__))
        output_file = os.path.join(vis_dir, f'robustness_knapsack_N{n}.png')
        plt.tight_layout()
        plt.savefig(output_file, dpi=300, bbox_inches='tight')
        print(f"✓ Saved: {output_file}")
        plt.close()
